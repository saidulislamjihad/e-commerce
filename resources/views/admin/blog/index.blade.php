                        ...
                        <div class="card-body">
                           ...
                           @elseif ($page == 'create')
                                ...
                                <form action="{{ url('/blog/store') }}" method="POST" enctype="multipart/form-data">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <textarea class="form-control mytextarea" name="description" id="" placeholder="Blog description"></textarea>
                                        <span style="color: red"> {{ $errors->has('title') ? $errors->first('title') : ' ' }}</span>
                                    </div>
                                    <div class="form-group">
                                        <label>Image</label>
                           ...
                           @elseif($page == 'edit')
                            ...
                            <form action="{{ url('/blog/update/'.$data->id) }}" method="POST" enctype="multipart/form-data">
                                ...
                                <div class="form-group">
                                    <label>Description</label>
                                    <textarea class="form-control mytextarea" name="description" id="" placeholder="Blog description">{{ $data->description }}</textarea>
                                    <span style="color: red"> {{ $errors->has('title') ? $errors->first('title') : ' ' }}</span>
                                </div>
                                <div class="form-group">
                                    <label>Image</label>
