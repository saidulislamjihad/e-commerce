                                   ...
                                   <tbody>
                                       @foreach ($ordersReports as $ordersReport)
                                        <tr>
                                            ...
                                            <td>{{ $ordersReport->order->user->full_name ?? 'No name found' }}</td>
                                            <td>{{ $ordersReport->qty }}</td>
                                            <td>{{ $ordersReport->product->regular_price ?? 'No name found' }} Tk.</td>
                                            <td>{{ $ordersReport->qty * $ordersReport->product->regular_price ?? 0 }} Tk.</td>
                                        </tr>
                                       @endforeach
                                   </tbody>
                               </table>
